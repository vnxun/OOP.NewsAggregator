...
public class VnexpressCollect {

    private static final int MAX_ARTICLES = 10000; // Set the maximum number of articles to scrape
    private static final String BASE_URL = "https://e.vnexpress.net/search?q=Blockchain&csrf=6776a72e671551d33233e7b518f91724";
    private static final String OUTPUT_FILE = "output6.csv";
        ...
        try {
            ...
            try (FileWriter writer = new FileWriter(OUTPUT_FILE)) {
                ...
                while (articleCount < MAX_ARTICLES) {
                    ...
                    for (WebElement articleElement : driver.findElements(By.cssSelector(".e1ln2bfr2 a"))) {
