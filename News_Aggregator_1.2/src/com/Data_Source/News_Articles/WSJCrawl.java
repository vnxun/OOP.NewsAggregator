...
public class WSJCrawl implements Runnable {
    private static final int MAX_DEPTH = 3;
    private static final Logger logger = Logger.getLogger(WSJCrawl.class.getName());
    ...
    public static void main(String[] args) {
        while (true) {
            ArrayList<String> links = readLinksFromCSV("input3.csv");
            ...
            for (BaseCrawler crawler : bots) {
                try {
                    ...
                    crawler.writeOutputToCSV("output3.csv");
