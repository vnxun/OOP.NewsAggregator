...
import com.Data_Source.BaseCrawler;
...
public class ChinaDailyCrawling implements Runnable {
    private static final int MAX_DEPTH = 3;
    private static final Logger logger = Logger.getLogger(ChinaDailyCrawling.class.getName());
    ...
    public ChinaDailyCrawling(String link) {
