...
public class VnexpressCrawl implements Runnable {
    private static final int MAX_DEPTH = 3;
    private static final Logger logger = Logger.getLogger(VnexpressCrawl.class.getName());
    ...
    public VnexpressCrawl(String link) {
    ...
    private String extractArticleAuthor(Document doc) {
        Element authorElement = doc.selectFirst("meta[property=article:author]");
    ...
    private String extractArticleContent(Document doc) {
        Element contentElement = doc.selectFirst("p.Normal");
    ...
    private boolean isBlockchainRelated(Document doc) {
        String paragraph = extractArticleContent_1(doc); // Extract content for blockchain check
    ...
    private String extractKeywords(Document doc) {
        Element keywordsElement = doc.selectFirst("meta[property=article:tag");
    ...
    public static void main(String[] args) {
        while (true) {
            ArrayList<String> links = readLinksFromCSV("input6.csv");
            ...
            for (BaseCrawler crawler : bots) {
                try {
                    ...
                    crawler.writeOutputToCSV("output6.csv");
