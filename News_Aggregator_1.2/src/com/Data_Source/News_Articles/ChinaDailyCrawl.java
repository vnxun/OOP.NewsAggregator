...
public class ChinaDailyCrawl implements Runnable {
    private static final int MAX_DEPTH = 3;
    private static final Logger logger = Logger.getLogger(ChinaDailyCrawl.class.getName());
    ...
    public ChinaDailyCrawl(String link) {
        System.out.println("ChinaDailyCrawl created");
        firstLink = link;
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            ArrayList<ChinaDailyCrawl> crawlers = new ArrayList<>();

            for (String link : links) {
                ChinaDailyCrawl crawler = new ChinaDailyCrawl(link);
                crawlers.add(crawler);
            }

            for (ChinaDailyCrawl crawler : crawlers) {
                try {
